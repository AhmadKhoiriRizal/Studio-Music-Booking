                ...
                <div class="row w-100 gy-10 mb-md-20">
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img src="/metronic8/demo1/assets/media/illustrations/sketchy-1/2.png" class="mh-125px mb-9"
                                alt="">
                            <!--end::Illustration-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img src="/metronic8/demo1/assets/media/illustrations/sketchy-1/8.png" class="mh-125px mb-9"
                                alt="">
                            <!--end::Illustration-->
                ...
                <div class="tns tns-default tns-initiazlied">
                    ...
                    <div class="tns-outer" id="tns1-ow">
                        <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide
                            <span class="current">5</span> of 4
                        </div>
            ...
            <div class="container">
                ...
                <div class="tns tns-default tns-initiazlied" style="direction: ltr">
                    ...
                    <div class="tns-outer" id="tns2-ow">
                        <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide
                            <span class="current">5 to 7</span> of 7
                        </div>
                        <div id="tns2-mw" class="tns-ovh">
                            <div class="tns-inner" id="tns2-iw">
                                <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false"
                                    ...
                                    class="  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" id="tns2"
                    ...
                    <!--begin::Button-->
                    <button class="btn btn-icon btn-active-color-primary" id="kt_team_slider_prev" aria-controls="tns2"
                        tabindex="-1" data-controls="prev">
                        <i class="ki-duotone ki-left fs-2x"></i> </button>
                    <!--end::Button-->

                    <!--begin::Button-->
                    <button class="btn btn-icon btn-active-color-primary" id="kt_team_slider_next" aria-controls="tns2"
                        tabindex="-1" data-controls="next">
                        <i class="ki-duotone ki-right fs-2x"></i> </button>
                    <!--end::Button-->
                </div>
                            ...
                            <ul class="nav border-transparent flex-center fs-5 fw-bold" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 active" href="#"
                                        data-bs-toggle="tab" data-bs-target="#kt_landing_projects_latest"
                                        aria-selected="true" role="tab">Latest</a>
                                </li>
