...
<div class="step" data-step="3" id="step-3">
    ...
    {{-- <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="tinggi_badan" name="tinggi_badan"
                placeholder="Tinggi badan dalam cm" required />
        ...
        <div class="col-md-6">
            ...
            <input type="number" class="form-control" id="berat_badan" name="berat_badan"
                placeholder="Berat badan dalam kg" required />
                    ...
                    <ul class="nav nav-pills d-flex justify-content-between nav-pills-custom gap-3 mb-6">
                        ...
                        <li class="nav-item mb-3 me-0">
                            ...
                            <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg show active"
                                data-bs-toggle="pill" href="#kt_pos_food_content_1" style="width: 120px;height: 150px">
                                <!--begin::Icon-->
                                <div class="nav-icon mb-3">
                                    <!--begin::Food icon-->
                                    <img src="{{ asset('media/svg/food-icons/spaghetti.svg') }}" class="w-50px"
                                        alt="" />
                                    <!--end::Food icon-->
                                </div>
                                <!--end::Icon-->
                        ...
                        <li class="nav-item mb-3 me-0">
                            ...
                            <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg "
                                data-bs-toggle="pill" href="#kt_pos_food_content_2" style="width: 120px;height: 150px">
                                <!--begin::Icon-->
                                <div class="nav-icon mb-3">
                                    <!--begin::Food icon-->
                                    <img src="{{ asset('media/svg/food-icons/salad.svg') }}" class="w-50px" alt="" />
                                    <!--end::Food icon-->
                                </div>
                                <!--end::Icon-->
                        ...
                        <li class="nav-item mb-3 me-0">
                            <!--begin::Nav link-->
                            <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg "
                                data-bs-toggle="pill" href="#kt_pos_food_content_3" style="width: 120px;height: 150px">
                                <!--begin::Icon-->
                                <div class="nav-icon mb-3">
                                    <!--begin::Food icon-->
                                    <img src="{{ asset('media/svg/food-icons/cheeseburger.svg') }}" class="w-50px"
                                        alt="" />
                                    <!--end::Food icon-->
                                </div>
                                <!--end::Icon-->
                        ...
                        <li class="nav-item mb-3 me-0">
                            <!--begin::Nav link-->
                            <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg "
                                data-bs-toggle="pill" href="#kt_pos_food_content_4" style="width: 120px;height: 150px">
                                <!--begin::Icon-->
                                <div class="nav-icon mb-3">
                                    <!--begin::Food icon-->
                                    <img src="{{ asset('media/svg/food-icons/coffee.svg') }}" class="w-50px" alt="" />
                                    <!--end::Food icon-->
                                </div>
                                <!--end::Icon-->
                        ...
                        <li class="nav-item mb-3 me-0">
                            <!--begin::Nav link-->
                            <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg "
                                data-bs-toggle="pill" href="#kt_pos_food_content_5" style="width: 120px;height: 150px">
                                <!--begin::Icon-->
                                <div class="nav-icon mb-3">
                                    <!--begin::Food icon-->
                                    <img src="{{ asset('media/svg/food-icons/cheesecake.svg') }}" class="w-50px"
                                        alt="" />
                                    <!--end::Food icon-->
                                </div>
                                <!--end::Icon-->
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <span class="text-gray-500 fw-semibold d-block fs-6 mt-n1">16 mins to
                                                    cook</span>
                                            </div>
                                            <!--end::Title-->
                                        </div>
    ...
    <div class="d-flex flex-stack rounded-3 p-6 gap-3">
        <div class="d-flex flex-stack bg-success rounded-3 p-6 w-100"
            style="height: -webkit-fill-available; align-items: flex-start;">
            <!--begin::Content-->
