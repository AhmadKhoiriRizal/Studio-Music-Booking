...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" class="bg-body position-relative app-blank"
    ...
    <!--begin::Root-->
    <div class="d-flex flex-column flex-root" id="beranda">
        ...
        <div class="mb-0" id="beranda">
            ...
            <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg"
                                    ...
                                    <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-600 menu-state-title-primary nav nav-flush fs-5 fw-semibold"
                                        ...
                                        <div class="d-flex m-3 gap-2">
                                            ...
                                            @else
                                                ...
                                                <div class="menu-item">
                                                    <!--begin::Menu link-->
                                                    <a class="btn btn-success py-3 px-4 px-xxl-6" href="/signin"
                                                        data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">
                                                        Login </a>
                                                    <!--end::Menu link-->
                                                </div>
                                                ...
                                                <div class="menu-item">
                                                    <!--begin::Menu link-->
                                                    <a class="btn btn-success py-3 px-4 px-xxl-6" href="/signup"
                                                        data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">
                                                        Register </a>
                                                    <!--end::Menu link-->
                                                </div>
               ...
               animation: typing 5s steps(33, end) infinite,
                        ...
                        <!--begin::Action-->
                        <a href="#tentang-kami" class="btn btn-primary">Jelajahi</a>
                        <!--end::Action-->
                    </div>
                    <!--end::Heading-->
                    ...
                    <div class="d-flex flex-center flex-wrap position-relative px-5">
                        ...
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" aria-label="Fujifilm"
                            ...
                            <img src="" class="mh-30px mh-lg-40px" alt="">
                        </div>
                        <!--end::Client-->
        ...
        <div class="mb-n10 mb-lg-n20 z-index-2">
            ...
            <div class="container">
                ...
                <div class="text-center mb-17">
                    <!--begin::Title-->
                    <h3 class="fs-2hx text-gray-900 mb-5" id="tentang-kami"
            ...
            <!--Studiooo-->
            <!--begin::Wrapper-->
            <div class="py-20" style="background-color: #f4f4f4">
                <!--begin::Container-->
                <div class="container">
                    <!--begin::Plans-->
                    <div class="d-flex flex-column container pt-lg-0">
                        ...
                        <div class="mb-13 text-center">
                            <h1 class="fs-2hx fw-bold text-black mb-5" id="paket-favorit"
            ...
            <div class="position-relative z-index-2" id="galeri">
                <!--begin::Container-->
                {{-- <div class="container"> --}}
                    <!--begin::Card-->
                    <div class="card"
                        style="background-color: #f4f4f4; border-radius: 0px;">
                        <!--begin::Card body-->
                        <div class="py-20 card-body container">
                            <!--begin::Heading-->
                            <div class="text-center mb-5 mb-lg-10">
                                ...
                                <ul class="nav border-transparent flex-center fs-5 fw-bold" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-gray-500 text-active-primary px-3 px-lg-6 active"
                                            href="#" data-bs-toggle="tab" data-bs-target="#kt_landing_projects_latest"
            ...
            <div class="position-relative z-index-2">
                ...
                <div class="py-20 card-body container">
                    {{-- <div class="container"> --}}
                        ...
                        <div class="text-center mb-17">
                            <!--begin::Title-->
                            <h3 class="fs-2hx text-gray-900 mb-5" id="testimoni"
                                ...
                                <div
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <div class="text-gray-500 fw-semibold fs-4">
                                            ...
                                            dan ruangan juga kedap suara sehingga latihan jadi lebih fokus tanpa
                                            gangguan.
                                        </div>
                                        <!--end::Feedback-->
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <div class="text-gray-500 fw-semibold fs-4">
                                            ...
                                            Pas sampai, semua sudah siap: ruangan rapi, alat musik lengkap, dan sound
                                ...
                                <div
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <div class="text-gray-500 fw-semibold fs-4">
                                            ...
                                            Sebagai orang yang sering latihan untuk persiapan event, saya bisa bilang
                                            kalau studio ini salah satu yang terbaik.
                                            Sound system benar-benar jernih, ruangan kedap suara, dan tata ruangnya
                                            sangat mendukung.
                                        </div>
                                        <!--end::Feedback-->
                                    </div>
                    ...
                    <!-- Footer Section -->
                    <footer class="bg-dark py-4 w-100">
                        <div
                            ...
                            <div class="d-flex align-items-center mb-3 mb-md-0">
                                <div class="me-3">
                                    <img src="{{ asset('media/studio/logostudio.png') }}" alt="logo" {{--
                                        class="rounded-circle" --}} style="height:40px; width:auto;">
                                </div>
