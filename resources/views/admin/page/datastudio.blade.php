                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                            data-kt-menu="true" id="kt_menu_68ae8668d5645">
                                            <!--begin::Header-->
                                            <div class="px-7 py-5">
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <div>
                                                        <select class="form-select form-select-solid" multiple
                                                            ...
                                                            data-dropdown-parent="#kt_menu_68ae8668d5645"
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        ...
                                                        <div
                                                            ...
                                                            <a
                                                                href="/metronic8/demo1/apps/user-management/users/view.html">
                                                                <div class="symbol-label">
                                                                    <img src="{{ asset('media/avatars/300-5.jpg') }}"
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        ...
                                                        <div
                                                            ...
                                                            <a
                                                                href="/metronic8/demo1/apps/user-management/users/view.html">
                                                                <div class="symbol-label">
                                                                    <img src="{{ asset('media/avatars/300-13.jpg') }}"
                        ...
                        <div class="card-body p-0">
                                ...
                                <div class="row " data-kt-buttons="true"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            ...
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="{{ asset('media/preview/demos/demo1/light-ltr.png') }}"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="{{ asset('media/preview/demos/demo1/dark-ltr.png') }}"
                                                    class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="mb-6">
                                    ...
                                    <a href="/metronic8/demo1/layout-builder.html" class="fw-semibold text-primary">More
                                        layout options</a>
                                </div>
                                <!--end::Heading-->
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol  symbol-35px symbol-circle "><img alt="Pic"
                                        src="{{ asset('media/avatars/300-25.jpg') }}" /></div><!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo1/index.html"
                                                    ...
                                                    <span
                                                        ...
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo1.png') }}"
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo2/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo2.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo39/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo39.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo31/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo31.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo9/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo9.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo38/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo38.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo30/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo30.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo6/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo6.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo60/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo60.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo8/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo8.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo62/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo62.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo58/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo58.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo56/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo56.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo34/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo34.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo27/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo27.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo29/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo29.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo57/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo57.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo3/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo3.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo36/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo36.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo20/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo20.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo59/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo59.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo55/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo55.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo51/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo51.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo10/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo10.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo61/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo61.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo52/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo52.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo63/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo63.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo40/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo40.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo23/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo23.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo64/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo64.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo35/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo35.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo33/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo33.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo19/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo19.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo25/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo25.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo50/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo50.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo32/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo32.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo37/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo37.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo42/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo42.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo5/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo5.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo16/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo16.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo4/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo4.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo53/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo53.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo7/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo7.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo21/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo21.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo24/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo24.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo28/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo28.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo44/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo44.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo11/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo11.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo26/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo26.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo22/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo22.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo41/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo41.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo18/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo18.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo54/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo54.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo15/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo15.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo14/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo14.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo13/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo13.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo12/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo12.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo48/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo48.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo17/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo17.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo49/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo49.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo43/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo43.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo45/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo45.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo47/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo47.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="https://preview.keenthemes.com/metronic8/demo46/index.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/demos/demo46.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/index.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/multipurpose-demo1.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/dashboards/marketing.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/marketing.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/dashboards/social.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/social.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/dashboards/ecommerce.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/ecommerce.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <a href="/metronic8/demo1/dashboards/store-analytics.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/store-analytics.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/dashboards/logistics.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/logistics.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/dashboards/delivery.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/delivery.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <a href="/metronic8/demo1/dashboards/online-courses.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/online-courses.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/dashboards/school.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/school.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/dashboards/crypto.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/crypto.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <a href="/metronic8/demo1/dashboards/finance-performance.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/finance-performance.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <a href="/metronic8/demo1/dashboards/website-analytics.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/website-analytics.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/dashboards/bidding.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/bidding.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/dashboards/podcast.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/podcast.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/dashboards/projects.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/projects.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <a href="/metronic8/demo1/dashboards/call-center.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/call-center.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/dashboards/pos.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/dashboards/pos.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/apps/projects/list.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/projects.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="/metronic8/demo1/apps/ecommerce/catalog/products.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/ecommerce.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/apps/customers/list.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/customers.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/apps/subscriptions/list.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/subscriptions.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="/metronic8/demo1/apps/user-management/users/list.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/user-management.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/apps/invoices/create.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/invoices.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="/metronic8/demo1/apps/support-center/overview.html"
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/support-center.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/apps/chat/private.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/chat.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/apps/calendar.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/calendar.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/apps/file-manager/folders.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/file-manager.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/apps/inbox/listing.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/inbox.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="/metronic8/demo1/apps/contacts/getting-started.html"
                                                    data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                    ...
                                                    <span
                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                            data-src="{{ asset('media/preview/prebuilts/apps/contacts.png') }}"
                                                            class="lozad w-100 rounded" alt="" />
                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/layouts/corporate/sign-in.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-corporate.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/layouts/creative/sign-in.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-creative.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/layouts/fancy/sign-in.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-fancy.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/layouts/overlay/sign-in.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-overlay.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/extended/multi-steps-sign-up.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-multistep.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/layouts/corporate/two-factor.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-2factor.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/general/password-confirmation.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-passwordchanged.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/general/verify-email.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-verifyemail.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/general/welcome.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-welcome.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/general/coming-soon.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-comingsoon.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/general/account-deactivated.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-accountdeactivated.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/general/error-404.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-404.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/general/error-500.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/auth-500.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/user-profile/overview.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/profile-overview.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/user-profile/campaigns.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/profile-campaigns.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/user-profile/documents.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/profile-documents.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/user-profile/followers.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/profile-followers.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/user-profile/activity.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/profile-activity.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/about.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/corporate-aboutus.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/contact.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/corporate-contactus.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/licenses.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/corporate-license.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/team.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/corporate-ourteam.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/sitemap.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/corporate-sitemap.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/social/feeds.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/social-activity.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/social/activity.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/social-feeds.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/social/followers.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/social-followers.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/social/settings.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/social-settings.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/faq/classic.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/faq-classic.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/faq/extended.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/faq-extended.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/blog/home.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/blog-home.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <a href="/metronic8/demo1/pages/blog/post.html"
                                                                    ...
                                                                    <span
                                                                        class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                        <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                            data-src="{{ asset('media/preview/prebuilts/pages/blog-post.png') }}"
                                                                            class="lozad w-100 rounded" alt="" />
                                                                    </span>
                                                                    <!--end::Thumbnail-->
                                                                </a>
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_account"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/account/overview.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/account-overview.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/account/settings.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/account-settings.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/account/billing.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/account-billing.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/account/security.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/account-security.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/account/referrals.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/account-referrals.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo1/account/logs.html" data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                                class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/account-logs.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/account/api-keys.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/account-apikeys.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/account/statements.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/account-statements.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/general/view-users.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-viewfriends.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/general/upgrade-plan.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-upgradeplan.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/wizards/top-up-wallet.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-topupwallet.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/general/share-earn.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-shareandearn.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/general/select-users.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-selectuser.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/forms/bidding.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-placeyourbid.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/wizards/offer-a-deal.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-offeradeal.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/forms/new-target.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-newtarget.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/forms/new-card.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-newcard.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/forms/new-address.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-newaddress.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/general/invite-friends.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-invitefriend.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/wizards/create-project.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-createproject.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/wizards/create-campaign.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-createcampaign.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/wizards/create-account.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-createbusinessacc.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/wizards/create-app.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-createapp.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/forms/create-api-key.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-createapikey.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/modals/wizards/two-factor-authentication.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/modal-2factorauth.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/wizards/horizontal.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/wizard-2factorauth.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/wizards/horizontal.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/wizard-horizontal.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/wizards/vertical.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/wizard-vertical.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_search"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo1/utilities/search/users.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/search-users.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/search/horizontal.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/search-horizontal.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/utilities/search/vertical.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/search-vertical.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo1/utilities/search/select-location.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/search-location.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_widgets"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo1/widgets/charts.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/widgets-charts.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo1/widgets/feeds.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/widgets-feeds.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo1/widgets/lists.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/widgets-lists.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo1/widgets/mixed.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/widgets-mixed.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/widgets/statistics.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/widgets-stats.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="/metronic8/demo1/widgets/tables.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/widgets-tables.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/email/welcome-message.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/email-welcome.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/email/subscription-confirmed.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/email-subscriptionconfirmed.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/email/reset-password.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/email-resetpassword.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/email/card-declined.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/email-creditcarddeclined.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/email/promo-1.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/email-promo1.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/email/promo-2.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/email-promo2.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <a href="/metronic8/demo1/authentication/email/promo-3.html"
                                                            ...
                                                            <span
                                                                class="app-prebuilts-thumbnail rounded ms-12 mb-n6 mb-lg-n15 me-n6 mh-350px overflow-hidden">
                                                                <img src="{{ asset('media/preview/demos/placeholder.jpg') }}"
                                                                    data-src="{{ asset('media/preview/prebuilts/pages/email-promo3.png') }}"
                                                                    class="lozad w-100 rounded" alt="" />
                                                            </span>
                                                            <!--end::Thumbnail-->
                                                        </a>
